...
PROFILES: dict[str, VideoModelProfile] = {
    "ltxv": VideoModelProfile(
        native_fps=24.0, native_max_frames=49, frame_step=8, frame_base=9,
        supports_img2video=True, default_width=768, default_height=512,
    ),
    "wan": VideoModelProfile(
        native_fps=16.0, native_max_frames=81, frame_step=4, frame_base=1,
        supports_img2video=False, default_width=832, default_height=480,
    ),
    "cogvideox": VideoModelProfile(
        native_fps=8.0, native_max_frames=49, frame_step=8, frame_base=1,
        supports_img2video=True, default_width=720, default_height=480,
    ),
}
