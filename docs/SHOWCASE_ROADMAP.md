...
- [x] `upscale` — tight crop comparison committed to `examples/upscale/crop-comparison.jpg` (same lid/foam zone at 960×1280 input vs 3840×5120 NMKD-Siax 4×). Added to README Gallery.
- [x] Add an **"Image pipelines"** subsection to the README Gallery with these. All four pipelines now covered: product_shot, photo_finalize, upscale, responsive_set.
